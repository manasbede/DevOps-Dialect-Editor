 ...
 */
package ca.mcgill.devops.pipeline.pipeline.util;
...
public class PipelineAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link ca.mcgill.devops.pipeline.pipeline.Pipeline <em>Pipeline</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link ca.mcgill.devops.pipeline.pipeline.Configurations <em>Configurations</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
